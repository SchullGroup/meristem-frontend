# RegisPro CPA — Share Registrar Management System

**MRPSL-CPA** is the front-end web application for RegisPro's **Central Processing Application (CPA)** — a comprehensive share registrar management platform. It is used by registrar staff and administrators to manage the full lifecycle of company shares, shareholders, dividends, and corporate actions on behalf of listed companies in Nigeria.

---

## What Does This Application Do?

In the Nigerian capital market, a **share registrar** is a company (like RegisPro Registrars) that keeps official records of who owns shares in a public company. When you buy shares of a company listed on the Nigerian Exchange (NGX), your name and share balance are recorded in a **register** maintained by the registrar.
...
_For technical questions or issues, please contact the development team._
