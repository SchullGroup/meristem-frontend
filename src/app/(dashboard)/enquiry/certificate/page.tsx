              ...
              <tbody className="divide-y font-mono text-[13px]">
                <tr className="hover:bg-accent/5">
                  ...
                  <td className="p-3 text-center">
                    <Badge
                      variant="outline"
                      className="bg-green-50 text-green-700 border-green-200 text-[13px]"
                    >
                      Yes
                    </Badge>
                  </td>
                  ...
                  <td className="p-3 text-center">
                    <Button
                      ...
                      size="icon"
                      title="Split"
                      onClick={() => router.push("/certificates/split")}
                    >
                  ...
                  <td className="p-3 text-center">
                    <Button
                      ...
                      size="icon"
                      title="Transfer"
                      onClick={() => router.push("/certificates/transfer")}
                    >
