...
import { Check, Scissors, AlertCircle, X } from "lucide-react";
                  ...
                  <Card className="mrpsl-card p-6 space-y-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-4">
                        <span className="text-sm font-medium w-16">Part 1</span>
                        <Input
                          type="number"
                          defaultValue="10000"
                      ...
                      <div className="flex items-center gap-4">
                        <span className="text-sm font-medium w-16">Part 2</span>
                        <Input
                          type="number"
                          defaultValue="5000"
                          className="mrpsl-input font-mono w-32"
