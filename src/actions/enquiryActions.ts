...
export const getWarrants = async (
...
export const getWarrantDetail = async (
    warrantNo: string,
) => {
    try {
...
export const getRightsEntitlements = async (
    params: SearchRightsParams,
) => {
    try {
        const response = await api.get<RightsSearchResponse>(
            "/enquiry/rights",
            {
                params,
            },
...
export const getShareholderSummary = async (
...
export const getHolderProfile = async (
    id: string,
) => {
    try {
        const response = await api.get<
