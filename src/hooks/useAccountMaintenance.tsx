import { authoriseAdmon, authoriseAdmonReversal, authoriseConsolidation, authoriseKycChange, batchAuthoriseAdmons, batchAuthoriseConsolidations, batchAuthoriseKycChanges, batchRejectAdmons, batchRejectConsolidations, batchRejectKycChanges, createAdmon, createAdmonReversal, createConsolidation, createKycChange, getAccount, getAccountKycHistory, getAccounts, getAdmon, getAdmonReversals, getAdmons, getConsolidation, getConsolidations, getConsolidationUploadJob, getKycChanges, getKycChangesUploadJob, rejectAdmon, rejectAdmonReversal, rejectConsolidation, rejectKycChange, uploadConsolidations, uploadKycChanges } from "@/actions/accountMaintenanceActions";
...
export const useGetAccount = (
    ...
    options?: Omit<
        UseQueryOptions<
            ApiResponse<ShareholderAccount>
        >,
        "queryKey" | "queryFn"
    >,
) =>
...
export const useCreateKycChange = (
    ...
    return useMutation({
        mutationFn: ({ accountNumber, data }: { accountNumber: string, data: CreateKycChangeRequest }) => createKycChange(accountNumber, data),
        ...options,
        onSuccess: () => {
...
export const useUploadKycChanges = (
    ...
    useMutation({
        mutationFn: ({ file, registerId }) =>
            uploadKycChanges(file, registerId),
        ...options,
    });
...
export const useGetAdmon = (
    id: number,
    options?: Omit<
        UseQueryOptions<ApiResponse<Admon>>,
        "queryKey" | "queryFn"
    >,
) =>
    useQuery({
...
export const useGetAdmonReversals = (
    ...
    options?: Omit<
        UseQueryOptions<
            ApiResponse<AdmonReversalListResponse>
        >,
        "queryKey" | "queryFn"
    >,
) =>
...
export const useCreateAdmonReversal = (
    ...
    return useMutation({
        mutationFn: ({ admonId, data }) =>
            createAdmonReversal(admonId, data),
