...
export const useGetAllCertificateDemat = (
  params?: DematParams,
  options?: Omit<
    UseQueryOptions<
      ContentPaginatedResponse<Demat>,
      any,
      ContentPaginatedResponse<Demat>
    >,
    "queryKey" | "queryFn"
...
export const useGetDematRecordById = (
  id: string,
  options?: Omit<UseQueryOptions<Demat, any, Demat>, "queryKey" | "queryFn">,
) => {
  return useQuery({
    queryKey: ["demat", id],
...
export const useGetWorkflowStageCounts = (
  options?: Omit<
    UseQueryOptions<
      {
        [key: string]: number;
