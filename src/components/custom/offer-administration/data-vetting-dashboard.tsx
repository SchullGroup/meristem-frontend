        ...
        <Tabs defaultValue="rejected">
          <div className="px-5 pt-0 border-b border-border">
            <TabsList className="h-auto p-0 bg-transparent gap-6 rounded-none">
              <TabsTrigger
                value="rejected"
                className="rounded-none px-0 py-3 text-[13px] font-medium text-muted-foreground data-active:text-primary data-active:border-b-2 data-active:border-primary border-b-2 border-transparent"
              >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-2 pt-2 border-t border-border justify-end">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => toast.info("Mark as distinct coming soon")}
                      >
                        Approve as Distinct
                      </Button>
                      <Button
