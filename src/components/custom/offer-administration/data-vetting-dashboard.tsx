...
const MOCK_VALID: ValidApplication[] = [
  {
    ...
    chn: "10022334455",
    applicationRef: "IPO-2024-00010",
    unitsApplied: 20000,
    amountPaid: 450000,
    stockbroker: "RegisPro Securities",
  },
  {
    id: "v2",
    applicantName: "Amaka Obi",
    chn: "10033445566",
    applicationRef: "IPO-2024-00011",
    unitsApplied: 10000,
    amountPaid: 225000,
  ...
  {
    id: "v3",
    applicantName: "Gbenga Adeyemi",
    chn: "10044556677",
    applicationRef: "IPO-2024-00012",
    unitsApplied: 5000,
    amountPaid: 112500,
  ...
  {
    id: "v4",
    applicantName: "Hauwa Musa",
    chn: "10055667788",
    applicationRef: "IPO-2024-00013",
    unitsApplied: 50000,
    amountPaid: 1125000,
...
export function DataVettingDashboard({
  ...
  const duplicatesExportRows = [
    ...
    ...MOCK_DUPLICATES.map((g) => [
      g.matchType,
      g.applications[0].applicantName,
      g.applications[0].applicationRef,
      g.applications[1]?.applicantName ?? "",
      g.applications[1]?.applicationRef ?? "",
    ]),
  ];
        ...
        <Tabs defaultValue="valid" className="flex-1 flex flex-col min-h-0">
          ...
          >
            <div className="px-5 py-3 border-b border-border shrink-0 flex items-center gap-3">
              ...
              <ExportButtons
                rows={validExportRows}
                basename="valid_applications"
              />
            </div>
                    ...
                    filteredValid.map((v) => (
                      <tr key={v.id} className="mrpsl-table-row">
                        ...
                        <td className="px-4 py-2.5 text-right font-mono">
                          {v.unitsApplied.toLocaleString()}
                        </td>
                        <td className="px-4 py-2.5 text-right font-mono">
                          ₦{v.amountPaid.toLocaleString()}
                        </td>
          ...
          >
            <div className="px-5 py-3 border-b border-border shrink-0 flex items-center gap-3">
              ...
              <ExportButtons
                rows={rejectedExportRows}
                basename="rejected_applications"
              />
            </div>
            <div className="flex-1 overflow-y-auto">
              <table className="w-full text-sm">
            ...
            <div className="flex h-full">
              ...
              <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
                <div className="px-5 py-3 border-b border-border shrink-0 flex justify-end">
                  <ExportButtons
                    rows={duplicatesExportRows}
                    basename="duplicate_groups"
                  />
                </div>
                  ...
                  {!selectedDupGroup ? (
                    <div className="h-full flex flex-col items-center justify-center text-center gap-2">
                      ...
                      <p className="text-xs text-muted-foreground max-w-xs">
                        Click a group on the left to compare the applications
                        side by side.
                      </p>
                    </div>
                  ) : (
