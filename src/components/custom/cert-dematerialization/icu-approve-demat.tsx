...
import { useGetAllCertificateDemat, useIcuApproveDematRequest, useRejectDematRequest } from "@/hooks/useCertDematerialisation";
...
export default function IcuApproveDemat({ tab }: { tab: string }) {
    ...
    if (isError) return <DataErrorState message="Failed to load authorised records." onRetry={() => refetch()} />;
    ...
    return (
        <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
                Authorised demat batches awaiting final ICU approval before lodgment at CSCS.
            </p>
