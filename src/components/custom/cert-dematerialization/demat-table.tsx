...
export function DematTable({
    ...
    const uncheckedIds = records.filter((r) => !selectedIds.has(r.id)).map((r) => r.id);
                    ...
                    <thead className="mrpsl-table-header">
                        <tr>
                            <th className="p-3 w-10">
                                <Checkbox checked={allSelected} onCheckedChange={() => toggleSelectAll(visibleIds)} />
                            </th>
                    ...
                    <tbody className="divide-y text-[13px]">
                        {records.map((row) => (
                            <tr key={row.id} className="mrpsl-table-row">
                                ...
                                <td className="p-3 font-mono truncate max-w-[160px]" title={row.certificates?.map((c) => c.certNo).join(", ")}>
                                ...
                                <td className="p-3 text-right tabular-nums font-semibold">{row.totalUnits?.toLocaleString() || 0}</td>
                ...
                <DialogContent className="max-w-md">
                    ...
                    <div className="space-y-4 px-6 pb-6">
                        ...
                        <div className="flex gap-3 pt-2 border-t">
                            <Button variant="ghost" className="flex-1" onClick={() => setBatchRejectOpen(false)}>
                                Cancel
                            </Button>
                            <Button variant="destructive" className="flex-1" onClick={handleBatchReject}>
                                Confirm Rejection
                            </Button>
                        </div>
                    </div>
