...
export const DEMAT_SHAREHOLDERS: DematShareholder[] = [
  {
    ...
    certificates: [
      {
        certNo: "DANGCEM/2019/001234",
        register: "DANGCEM",
        units: 15000,
        dateIssued: "15 Mar 2019",
        status: "ACTIVE",
      },
      {
        certNo: "DANGCEM/2022/004567",
        register: "DANGCEM",
        units: 5000,
        dateIssued: "10 Jun 2022",
        status: "ACTIVE",
      },
    ],
  },
  {
    ...
    certificates: [
      {
        certNo: "MTNN/2020/005678",
        register: "MTNN",
        units: 8000000,
        dateIssued: "20 Jan 2020",
        status: "ACTIVE",
      },
      {
        certNo: "MTNN/2021/009012",
        register: "MTNN",
        units: 4500000,
        dateIssued: "05 Sep 2021",
        status: "ACTIVE",
      },
      {
        certNo: "DANGCEM/2018/002345",
        register: "DANGCEM",
        units: 25000,
        dateIssued: "03 Nov 2018",
        status: "ACTIVE",
      },
    ],
  },
  {
    ...
    certificates: [
      {
        certNo: "GTCO/2021/007890",
        register: "GTCO",
        units: 120000,
        dateIssued: "12 Apr 2021",
        status: "ACTIVE",
      },
    ],
  },
...
export const DEMAT_STOCKBROKERS: DematStockbroker[] = [
  {
    id: "sb1",
    firmName: "RegisPro SECURITIES LIMITED",
    cscsCode: "MER001",
    phone: "01-7808790",
    email: "operations@RegisPro.com",
    address: "213 Herbert Macaulay Way, Yaba, Lagos",
    licenseNo: "SEC/BROKER/0012",
    mandateFile: {
      name: "RegisPro_mandate_list.pdf",
      url: "/uploads/mandates/RegisPro_mandate_list.pdf",
    },
    mandates: [
      {
        id: "mb1",
        ...
        agentName: "CHUKWUEMEKA IHEJIRIKA",
        position: "Operations Manager",
        phone: "08123456789",
        email: "c.ihejirika@RegisPro.com",
      },
      {
        id: "mb2",
        accountNo: "MRX0012345",
        holderName: "JOHN ADEYEMI BABATUNDE",
        agentName: "ADAEZE NWOSU OKAFOR",
        position: "Client Relations",
        phone: "08234567890",
        email: "a.nwosu@RegisPro.com",
      },
    ],
  },
  {
    ...
    mandateFile: {
      name: "cardinalstone_mandate_list.jpg",
      url: "/uploads/mandates/cardinalstone_mandate_list.jpg",
    },
    mandates: [
      {
        id: "mb3",
        ...
        agentName: "IBRAHIM USMAN HASSAN",
        position: "Senior Dealer",
        phone: "08056789012",
        email: "i.hassan@cardinalstone.com",
      },
    ],
  },
  {
    ...
    mandateFile: {
      name: "stanbic_mandate_list.pdf",
      url: "/uploads/mandates/stanbic_mandate_list.pdf",
    },
    mandates: [
      {
        id: "mb4",
        accountNo: "MRX0056789",
        holderName: "SAMUEL OLUWASEUN ADELEKE",
        agentName: "OLUWASEUN ADEYEMI BELLO",
        position: "Account Manager",
        phone: "08067890123",
        email: "o.bello@stanbicibtc.com",
      },
    ],
  },
];
...
export const DEMAT_CERTIFICATES: DematCertificate[] = [
  {
    certNo: "DANGCEM/2019/001234",
    register: "DANGCEM",
    description: "Dangote Cement Plc",
    holderName: "NGOZI CHIDINMA OKAFOR",
  ...
  },
  {
    certNo: "GTCO/2021/007890",
    register: "GTCO",
    description: "Guaranty Trust Holding Company Plc",
    holderName: "FATIMA ABUBAKAR MUSA",
...
export const SEED_REQUESTS: DematRequest[] = [
  {
    ...
    stockbrokerName: "RegisPro SECURITIES LIMITED",
    stockbrokerId: "sb1",
    totalUnits: 15000,
    unitPrice: 285,
  ...
  },
  {
    ...
    documents: {
      ...
      scannedCerts: [
        { name: "cert_005678.pdf", size: "2.1 MB" },
        { name: "cert_009012.pdf", size: "1.9 MB" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    status: "REJECTED",
    rejectionComment:
      "Demat form signature does not match shareholder signature on file. Please resubmit with corrected documentation.",
    rejectedBy: "HOD",
    documents: {
