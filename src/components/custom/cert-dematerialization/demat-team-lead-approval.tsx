...
// First-level review before HOD. Mirrors the HOD approval screen.
export function DematTeamLeadApproval({ requests, onApprove, onReject }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <h2 className="text-xl font-semibold">Team Lead Approval</h2>
        <Badge variant="secondary">{requests.length}</Badge>
      </div>
      <p className="text-sm text-muted-foreground">
        First-level review of dematerialization requests before HOD.
      </p>
