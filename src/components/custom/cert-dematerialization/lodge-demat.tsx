...
export default function LodgeDemat({ tab }: { tab: string }) {
    ...
    const [rinType, setRinType] = useState<"RIN_AT_CSCS" | "RIN_NOT_AT_CSCS">("RIN_AT_CSCS");
    ...
    return (
        <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
                ICU-approved records ready to be lodged at CSCS via text file download or direct API push.
            </p>
            ...
            <div className="flex items-center gap-2 mb-4">
                ...
                <RadioGroup
                    value={rinType}
                    onValueChange={(v) => setRinType(v as "RIN_AT_CSCS" | "RIN_NOT_AT_CSCS")}
            ...
            {isError ? (<DataErrorState message="Failed to load ICU-approved records." onRetry={() => refetch()} />
            )
                : (<DematTable
                    records={records}
                    onReview={() => {
