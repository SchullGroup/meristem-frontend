        ...
        shares: [
          {
            ...
            certificates: [
              {
                id: "cert-004",
                certNo: "DANGCEM/2020/003456",
                units: 8500,
                issueDate: "22 Jul 2020",
                status: "ACTIVE",
              },
            ],
          },
        ...
        shares: [
          {
            ...
            certificates: [
              {
                id: "cert-007",
                certNo: "MTNN/2019/001122",
                units: 2000000,
                issueDate: "12 Feb 2019",
                status: "ACTIVE",
              },
              {
                id: "cert-008",
                certNo: "MTNN/2023/012345",
                units: 500000,
                issueDate: "30 Oct 2023",
                status: "ACTIVE",
              },
            ],
          },
        ...
        shares: [
          {
            ...
            certificates: [
              ...
              {
                id: "cert-010",
                certNo: "UBA/2019/008765",
                units: 20000,
                issueDate: "14 Jan 2019",
                status: "ACTIVE",
              },
            ],
          },
        ...
        shares: [
          {
            ...
            certificates: [
              {
                id: "cert-013",
                certNo: "UBA/2023/010123",
                units: 12000,
                issueDate: "02 May 2023",
                status: "ACTIVE",
              },
            ],
          },
        ...
        shares: [
          {
            ...
            certificates: [
              {
                id: "cert-014",
                certNo: "GTCO/2020/003214",
                units: 80000,
                issueDate: "20 Apr 2020",
                status: "ACTIVE",
              },
              {
                id: "cert-015",
...
export const SEED_CONSOLIDATION_REQUESTS: ConsolidationRequest[] = [
  {
    ...
    totalUnits: 28500,
    reason:
      "Account consolidation — multiple certificates across accounts in same register",
  ...
  },
  {
    ...
    submittedBy: "officer@RegisPro.com",
    status: "REJECTED",
    rejectionComment:
...
export function generateConsolidationCertNo(
  register: string,
  existing: ConsolidationRequest[],
): string {
