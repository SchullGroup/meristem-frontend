...
import { useApproveConsolidationRequest, useBatchApproveOrRejectConsolidationRequest, useRejectConsolidationRequest } from "@/hooks/useCertConsolidation";

export const ReviewConsolidation = ({ reviewOpen, setReviewOpen, selected, onSuccess }: {
    reviewOpen: boolean;
                                ...
                                {((): Array<{
                                    ...
                                    time?: string | null;
                                }> => [
                                        {
                                            ...
                                            time: selected.submittedAt ? new Date(selected.submittedAt).toLocaleString() : 'N/A',
                                        },
                                        {
...
export const RejectConsolidation = ({ selectedIds, batchRejectOpen, setBatchRejectOpen, onSuccess }: {
    selectedIds: string[];
