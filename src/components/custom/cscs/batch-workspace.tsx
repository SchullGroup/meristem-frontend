  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="font-mono text-sm font-semibold">{batch.batchRef}</span>
      </div>
        ...
        {STEPS.map((s, i) => {
          ...
          return (
            <div key={s.num} className="flex items-center gap-1 shrink-0">
              <button
                onClick={() => { setViewMode("step"); setActiveStep(s.num); }}
                className={`flex items-center gap-2 px-3 py-2 rounded-xl text-[13px] font-medium transition-all border
                  ${isActive
