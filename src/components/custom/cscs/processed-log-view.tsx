...
const SEED_LOG: ProcessedEntry[] = [
  {
    ...
    chn: "C0012345AK",
    register: "DANGCEM",
    holder: "JOHN ADEYEMI BABATUNDE",
    transferNo: "TRF-DANGCEM-001",
    type: "BUY",
    units: 2500,
    balanceAfter: 51300,
  ...
  },
  {
    ...
    chn: "C0034567CK",
    register: "MTNN",
    holder: "SAMUEL OLUWASEUN ADELEKE",
    transferNo: "TRF-MTNN-001",
    type: "BUY",
    units: 10000,
    balanceAfter: 80000,
    processedBy: "Abiola Kolawole",
  ...
  },
  {
    ...
    chn: "C0046789EK",
    register: "MTNN",
    holder: "ADAEZE CHIBUIKE IROEGBU",
    transferNo: "TRF-MTNN-003",
    type: "BUY",
    units: 2000,
    balanceAfter: 31500,
    processedBy: "Abiola Kolawole",
  ...
  },
  {
    ...
    chn: "C0056789EK",
    register: "SEPLAT",
    holder: "EMEKA CHUKWUEMEKA EZE",
    transferNo: "TRF-SEPLAT-001",
    type: "BUY",
    units: 5000,
    balanceAfter: 123000,
    processedBy: "Abiola Kolawole",
  ...
  },
  {
    ...
    chn: "C0078901GK",
    register: "UBA",
    holder: "IBRAHIM USMAN HASSAN",
    transferNo: "TRF-UBA-001",
    type: "BUY",
    units: 3000,
    balanceAfter: 67500,
    processedBy: "Abiola Kolawole",
  ...
  },
  {
    ...
    chn: "C0099123IK",
    register: "UBA",
    holder: "CHUKWUEMEKA OKAFOR",
    transferNo: "TRF-UBA-003",
    type: "BUY",
    units: 1500,
    balanceAfter: 23500,
    processedBy: "Abiola Kolawole",
  ...
  },
  {
    ...
    chn: "C0109234JK",
    register: "UBA",
    holder: "YETUNDE ADEFOPE ADEYEMI",
    transferNo: "TRF-UBA-005",
    type: "BUY",
    units: 2200,
    balanceAfter: 55400,
    processedBy: "Abiola Kolawole",
...
export function ProcessedLogView({ batchRef }: ProcessedLogViewProps) {
  ...
  const totalBuys = rows
    .filter((r) => r.type === "BUY")
    .reduce((a, r) => a + r.units, 0);
  const totalSells = rows
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center">
        <div className="grid grid-cols-[2fr_1fr_1fr_1fr] gap-2 w-2/3">
          ...
          <Select
            value={regFilter}
            onValueChange={(v) => setRegFilter(v ?? "All")}
          >
          ...
          <Select
            value={typeFilter}
            onValueChange={(v) =>
              setTypeFilter((v as "All" | "BUY" | "SELL") ?? "All")
            }
          >
        ...
        <div className="ml-auto flex items-center gap-4 text-[13px] text-muted-foreground">
          <span className="text-green-600 font-semibold tabular-nums">
            Buys: +{formatNumber(totalBuys)}
          </span>
          <span className="text-red-600 font-semibold tabular-nums">
            Sells: −{formatNumber(totalSells)}
          </span>
