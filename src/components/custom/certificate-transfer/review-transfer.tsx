...
import { useApproveTransferRequest, useBatchApproveOrRejectTransferRequest, useRejectTransferRequest } from "@/hooks/useCertTransfer";
import { useStore } from "@/lib/store";


export const ReviewTranser = ({ reviewOpen, setReviewOpen, selected, onSuccess }: {
    reviewOpen: boolean;
                ...
                {selected && (
                    <div className="space-y-6 px-8 pb-8">
                        <div className="bg-muted/30 rounded-xl border p-4 space-y-3">
                            ...
                            <div className="font-mono font-bold">{selected.sourceCertNumber}</div>
...
export const RejectTransfer = ({ selectedIds, selectedTransfers, batchRejectOpen, setBatchRejectOpen, onSuccess }: {
    selectedIds: string[];
