// Uploads any file to object storage (Huawei OBS) via the backend and returns its public URL.
// Kept as GetPDFUrl(file, folderName) with a { type, result } return shape for backwards
