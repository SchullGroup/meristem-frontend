...
// Lagos, Abuja (FCT), Rivers always first — rest alphabetical
export const NIGERIA_STATES: NigeriaState[] = [
  ...
  {
    name: "Cross River",
    lgas: ["Abi","Akamkpa","Akpabuyo","Bakassi","Bekwara","Biase","Boki","Calabar Municipal","Calabar South","Etung","Ikom","Obanliku","Obubra","Obudu","Odukpani","Ogoja","Yakuur","Yala"],
  },
  {
    name: "Delta",
